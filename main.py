...
# score_surf = test_font.render('O Jogo',False,(64,64,64))
# score_rect = score_surf.get_rect(center = (400,50))
...
game_name = test_font.render('Corredor > Dinossauro', False, (111,196,169))
...
while True:
    ...
    #desenhar todos os elementos e atualizar tudo que for necessário.
